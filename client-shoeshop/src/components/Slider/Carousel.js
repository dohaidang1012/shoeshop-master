      ...
      <div className="carousel">
        <div className="carousel-left">
          <div className="carousel-left-slide">
            ...
            >
              <div key={1}>
                <img src="https://res.cloudinary.com/cloudidg/image/upload/v1713520729/Product-Shoe/chuck_70_de_luxe_wedge_eng_main_desktop_b4dgqv.jpg"></img>
              </div>
              <div key={2}>
                <img src="https://res.cloudinary.com/cloudidg/image/upload/v1713520729/Product-Shoe/one_star_pro_eng_main_desktop_kukhb7.jpg"></img>
              </div>
              <div key={3}>
                <img src="https://res.cloudinary.com/cloudidg/image/upload/v1713520729/Product-Shoe/converse_x_golf_le_fleur_eng_main_desktop_xkzzxy.jpg"></img>
              </div>
            </Slider>
